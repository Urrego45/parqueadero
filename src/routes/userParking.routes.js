...
router.post('/setting-vehicule', authRequired, userParkingController.createUserParking)
router.put('/setting-vehicule/:uuid', authRequired, userParkingController.updateUserParking)
